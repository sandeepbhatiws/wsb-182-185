...
exports.create = async (request, response) => {
    ...
    if(request.body.name != ''){
        ...
        dataSave.slug = await generateUniqueSlug(subSubCategoryModal, slug)
    }

    subSubCategoryModal(dataSave).save()
        .then((result) => {
            const data = {
                _status: true,
...
exports.view = async (request, response) => {
    ...
    var totalRecords = await subSubCategoryModal.find(filter).countDocuments();
    ...
    subSubCategoryModal.find(filter)
        .select('name parent_category_id sub_category_id slug image order status')
...
exports.changeStatus = async (request, response) => {
    subSubCategoryModal.updateMany(
